  ...
  return (
    <div className={`fixed top-0 right-0 h-full w-64 bg-gray-800 text-white transform ${isOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out z-20`}>
        <div className="p-4 flex justify-end">
            <img src="/img/page/linea.png" alt="Cerrar" className="h-8 w-8 cursor-pointer" onClick={onClose}/>
        </div>
        <ul className="px-4">
            <li className="py-2"><Link href="/">Home</Link></li>
            <li className="py-2"><Link href="#">Nivel 1</Link></li>
            <li className="py-2"><Link href="#">Nivel 2</Link></li>
            <li className="py-2"><Link href="#">Nivel 3</Link></li>
