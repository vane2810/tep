// Página reutilizable para todos los niveles
"use client";
...
export default function NivelTemplate({ fullText, images, planetName, planetNumber, gameIntroLink, buttonLinks, separadorColor }) {
  ...
  // Función para elegir el separador según el color
  const renderSeparador = () => {
    if (separadorColor === "azul") {
      return <SeparadorAzul />;
    } else if (separadorColor === "rojo") {
      return <SeparadorRojo />;
    }
    return null; 
  };
