// Juego 4 - División de Decimales - Nivel 2
"use client";
...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: 'Calcula 0.6 ÷ 0.2', correctAnswer: '3' },
        { question: 'Calcula 0.8 ÷ 0.4', correctAnswer: '2' },
        { question: 'Calcula 0.9 ÷ 0.3', correctAnswer: '3' },
        { question: 'Calcula 1.2 ÷ 0.6', correctAnswer: '2' },
        { question: 'Calcula 1.5 ÷ 0.5', correctAnswer: '3' },
        { question: 'Calcula 2.4 ÷ 0.8', correctAnswer: '3' }
    ];
