// Juego 4 - Fracciones Equivalentes - Nivel 2
"use client";
...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: '¿Qué fracción es equivalente a 1/2?', correctAnswer: '2/4' },
        { question: '¿Qué fracción es equivalente a 3/6?', correctAnswer: '1/2' },
        { question: '¿Qué fracción es equivalente a 2/3?', correctAnswer: '4/6' },
        { question: '¿Qué fracción es equivalente a 3/4?', correctAnswer: '6/8' },
        { question: '¿Qué fracción es equivalente a 1/5?', correctAnswer: '2/10' },
        { question: '¿Qué fracción es equivalente a 4/8?', correctAnswer: '1/2' }
    ];
