...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: 'Calcula 0.5 x 0.2', correctAnswer: '0.10' },
        { question: 'Calcula 0.3 x 0.4', correctAnswer: '0.12' },
        { question: 'Calcula 0.6 x 0.5', correctAnswer: '0.30' },
        { question: 'Calcula 0.7 x 0.8', correctAnswer: '0.56' },
        { question: 'Calcula 0.9 x 0.9', correctAnswer: '0.81' },
        { question: 'Calcula 0.4 x 0.2', correctAnswer: '0.08' }
    ];
