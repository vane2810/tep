...
const Game1 = ({ updateFeedback, updateScore, showRetryButton }) => {
    ...
    useEffect(() => {
        ...
        function generateQuestion() {
            ...
            this.add.text(200, 120, `${num1}`, { fontSize: '28px', fill: '#000000' }).setData('label', 'Multiplicando'); 
            this.add.text(300, 120, 'x', { fontSize: '28px', fill: '#000000' });
            this.add.text(400, 120, `${num2}`, { fontSize: '28px', fill: '#000000' }).setData('label', 'Multiplicador');
            ...
            dropZones = [
                createDropZone.call(this, 200, 200, 'Multiplicando'), // Mover zonas hacia arriba
                createDropZone.call(this, 400, 200, 'Multiplicador'),
