// Juego 3 - Nivel 1 - Mate - Multiplicación
"use client";
  ...
  useEffect(() => {
    class NumberHuntScene extends Phaser.Scene {
      ...
      create() {
        ...
        this.targetProduct = Phaser.Math.Between(6, 100); // Número objetivo aleatorio para el producto
        this.canSelect = true;

        this.generateNewQuestion();
        
        // Mostrar el producto objetivo al jugador
        this.targetProductText = this.add.text(400, 50, `Encuentra dos números cuyo producto sea ${this.targetProduct}`, {
          fontSize: '24px',
          fill: '#000000'
        }).setOrigin(0.5);
      ...
      generateNewQuestion() {
        ...
        const numbers = Phaser.Utils.Array.NumberArray(1, 10); // Números del 1 al 10 para hacer el juego más razonable
        const pairedNumbers = numbers.concat(numbers.slice(0, 2)); // Duplicar algunos números para un total de 12
      ...
      selectNumber(numberText) {
        ...
        if (this.selectedNumbers.length === 2) {
          ...
          const product = num1 * num2; // Calcular el producto

          if (product === this.targetProduct) {
            memoizedUpdateFeedback('¡Correcto! Has encontrado una combinación que cumple con el producto objetivo.');
            ...
            memoizedUpdateFeedback('El producto no es correcto. Inténtalo de nuevo.');
            this.resetSelection();
          }
        }
      }
      ...
      moveToNextQuestion() {
        this.cleanUpScene();
        this.generateNewQuestion();
        this.targetProduct = Phaser.Math.Between(6, 100); // Nuevo número objetivo para el producto
        this.targetProductText.setText(`Encuentra dos números cuyo producto sea ${this.targetProduct}`);
        this.nextQuestionButton.setVisible(false); 
      }
