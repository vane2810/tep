// Juego 4 - Operaciones con Fracciones - Nivel 3
"use client";
...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: '1/2 + 1/4 = ?', correctAnswer: '3/4' },
        { question: '2/3 - 1/3 = ?', correctAnswer: '1/3' },
        { question: '1/4 * 2/3 = ?', correctAnswer: '1/6' },
        { question: '4/5 ÷ 2/5 = ?', correctAnswer: '2' },
        { question: '2/7 + 3/7 = ?', correctAnswer: '5/7' },
        { question: '5/6 - 1/6 = ?', correctAnswer: '2/3' }
    ];
