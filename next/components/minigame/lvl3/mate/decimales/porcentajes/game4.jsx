...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    // Preguntas actualizadas para porcentajes, fracciones y decimales
    const questions = [
        { question: '¿Qué porcentaje equivale a la fracción 1/2?', correctAnswer: '50%' },
        { question: 'Si 30% de una cantidad es 15, ¿cuál es la cantidad total?', correctAnswer: '50' },
        { question: '¿Qué fracción corresponde al 75%?', correctAnswer: '3/4' },
        { question: '¿Cuál es el decimal equivalente a 20%?', correctAnswer: '0.2' },
        { question: 'Si 40% de una cantidad es 8, ¿cuál es la cantidad total?', correctAnswer: '20' },
        { question: '¿Qué porcentaje es igual a 0.25?', correctAnswer: '25%' }
    ];
