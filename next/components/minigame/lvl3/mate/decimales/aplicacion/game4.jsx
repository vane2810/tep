...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: 'El precio de una manzana es $0.75, ¿cuánto pagarías por 3 manzanas?', correctAnswer: '2.25' },
        { question: 'Un coche recorre 8.5 km por cada litro de gasolina. ¿Cuántos litros necesita para recorrer 42.5 km?', correctAnswer: '5' },
        { question: 'El precio de un café es $1.50, ¿cuánto pagarías por 4 cafés?', correctAnswer: '6' },
        { question: 'Si compras un litro de leche que cuesta $1.20, ¿cuánto pagarías por 3 litros?', correctAnswer: '3.60' },
        { question: 'Un kilómetro de gasolina cuesta $1.25, ¿cuánto pagarías por recorrer 10 km?', correctAnswer: '12.5' },
        { question: 'Un litro de gasolina cuesta $2.40, ¿cuánto pagarías por 5 litros?', correctAnswer: '12' }
    ];
