...
const Game4 = ({ updateFeedback, updateScore, proceedToNextScene, isFinalScene, finalScore, restartGame, currentScene }) => {
    ...
    const questions = [
        { question: 'Suma: 1.5 + 2.3', correctAnswer: '3.8' },
        { question: 'Resta: 5.6 - 2.1', correctAnswer: '3.5' },
        { question: 'Suma: 0.7 + 0.8', correctAnswer: '1.5' },
        { question: 'Resta: 3.9 - 1.4', correctAnswer: '2.5' },
        { question: 'Suma: 4.2 + 3.1', correctAnswer: '7.3' },
        { question: 'Resta: 8.5 - 3.7', correctAnswer: '4.8' }
    ];
