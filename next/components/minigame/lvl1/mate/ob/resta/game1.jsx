...
const Game1 = ({ updateFeedback, updateScore, showRetryButton }) => {
    ...
    useEffect(() => {
        ...
        function generateQuestion() {
            ...
            this.add.text(200, 120, `${num1}`, { fontSize: '28px', fill: '#000000' }).setData('label', 'Minuendo'); 
            this.add.text(300, 120, '-', { fontSize: '28px', fill: '#000000' });
            this.add.text(400, 120, `${num2}`, { fontSize: '28px', fill: '#000000' }).setData('label', 'Sustraendo');
            ...
            dropZones = [
                createDropZone.call(this, 200, 200, 'Minuendo'), // Mover zonas hacia arriba
                createDropZone.call(this, 400, 200, 'Sustraendo'),
