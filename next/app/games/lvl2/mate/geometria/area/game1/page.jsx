// Juego 1 - Areas de figuras planas- Nivel 1
"use client";
...
const Game1 = dynamic(() => import('@/components/minigame/lvl2/mate/geometria/area/game1'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Que es el area?</h1>
            <Game1 
              key={gameKey} 
