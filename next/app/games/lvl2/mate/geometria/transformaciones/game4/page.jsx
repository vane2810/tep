...
const Game4 = dynamic(() => import('@/components/minigame/lvl2/mate/geometria/transformaciones/game4'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game4Modal
        ...
        subtitle="Identifiquemos las figuras"
      />

      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Identifiquemos las figuras</h1>
            <div className="mt-8">
