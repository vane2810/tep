// Juego 4 - Transformaciones geométricas- Nivel 2
"use client";
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Identifica las caracteristicas de las transformaciones geometricas</h1>
            <Game4 
              key={gameKey} 
