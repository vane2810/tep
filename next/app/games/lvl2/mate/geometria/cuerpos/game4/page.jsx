...
const Game4 = dynamic(() => import('@/components/minigame/lvl2/mate/geometria/cuerpos/game4'), { ssr: false });
    ...
    <main className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-between items-center">
        <div className="inline-block mb-20 ml-8">
          <Link href="/niveles/nivel2/mate/geometria/cuerpos/juegos">
      ...
      <Game4Modal
        ...
        subtitle="¿Como son las figuras?"
      />

      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Como son las figuras?</h1>
            <div className="mt-8">
