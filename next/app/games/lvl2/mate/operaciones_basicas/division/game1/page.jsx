...
const Game1 = dynamic(() => import('@/components/minigame/lvl2/mate/division/game1'), { ssr: false });
    ...
    <main className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-between items-center">
        ...
        <div className="inline-block mb-20 ml-8">
          <Link href="/niveles/nivel2/mate/operaciones_basicas/division/juegos">
        ...
        <div className="flex items-center mx-auto my-6">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/signodivision.png" alt="Resta" className="w-auto h-40" />
          </div>
          {/* Typewriter y botón */}
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Términos de la División</h1>
            <Game1 
              key={gameKey} 
