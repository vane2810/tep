// Juego 2 - Conversión de Decimales - Nivel 1
"use client";
...
const Game2 = dynamic(() => import('@/components/minigame/lvl2/mate/decimales/conversion/game2'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Conversión de Decimales"
      />
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Conversión de Decimales</h1>
            <Game2
