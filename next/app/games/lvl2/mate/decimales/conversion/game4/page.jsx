...
const Game4 = dynamic(() => import('@/components/minigame/lvl2/mate/decimales/conversion/game4'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Convirtamos entre fracciones y decimales"
      />
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Convirtamos entre fracciones y decimales</h1>
            <Game4 
              key={gameKey} 
