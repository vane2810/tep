...
const Game2 = dynamic(() => import('@/components/minigame/lvl2/mate/decimales/division/game2'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Pares divisibles</h1>
            <Game2 
              key={gameKey} 
