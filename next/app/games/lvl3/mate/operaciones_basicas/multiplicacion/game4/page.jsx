...
const Game4 = dynamic(() => import('@/components/minigame/lvl3/mate/multiplicacion/game4'), { ssr: false });
      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="flex items-center my-6 mx-auto">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/signomultiplicacion.png" alt="Resta" className="h-40 w-auto" />
          </div>
          {/* Typewriter y botón */}
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-6 text-center">Multiplicaciones Avanzadas</h1>
