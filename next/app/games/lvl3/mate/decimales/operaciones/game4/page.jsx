...
const Game4 = dynamic(() => import('@/components/minigame/lvl3/mate/decimales/operaciones/game4'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Operando con fracciones"
      />
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Operando con fracciones</h1>
            <Game4 
              key={gameKey} 
