// Juego 1 - Aplicación vida cotidiana - Nivel 3
"use client";
...
const Game1 = dynamic(() => import('@/components/minigame/lvl3/mate/decimales/aplicacion/game1'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-between items-center">
        ...
        <div className="flex items-center mx-auto my-6">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/compafig.png" alt="Decimales en la vida cotidiana" className="w-auto h-40" />
          </div>
          {/* Typewriter y botón */}
      ...
      <Game1Modal
        ...
        subtitle="Decimales en la Vida Cotidiana"
      />
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Aplicación de Decimales en la Vida Cotidiana</h1>
            <Game1 
              key={gameKey} 
