// Juego 4 - Aplicación en la Vida Cotidiana - Nivel 3
"use client";
...
const Game4 = dynamic(() => import('@/components/minigame/lvl3/mate/decimales/aplicacion/game4'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Cuanto seran?</h1>
            <Game4 
              key={gameKey} 
