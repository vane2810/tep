// Juego 3 - Aplicación en la Vida Cotidiana - Nivel 3
"use client";
...
const Game3 = dynamic(() => import('@/components/minigame/lvl3/mate/decimales/aplicacion/game3'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="flex items-center my-6 mx-auto">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/compafig.png" alt="Aplicación en la Vida Cotidiana" className="h-40 w-auto" />
          </div>
          {/* Typewriter y botón */}
      ...
      <Game1Modal
        ...
        subtitle="Aplicación en la Vida Cotidiana"
      />
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Aplicación en la Vida Cotidiana</h1>
            <Game3 
              key={gameKey} 
