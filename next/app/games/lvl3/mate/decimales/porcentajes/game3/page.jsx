...
const Game3 = dynamic(() => import('@/components/minigame/lvl3/mate/decimales/porcentajes/game3'), { ssr: false });
...
const GamePage3 = () => {
  ...
  const updateScore = (newScore) => {
    setScore(newScore); // Actualizar directamente al nuevo valor, ya que cada respuesta correcta es 40 puntos
  };
  ...
  const finalizeGame = (finalScore) => {
    if (finalScore >= 120) {
      ...
      setShowRetryButton(true); // Mostrar botón de "Volver a Intentar" si no alcanzó 120 puntos
    }
  };
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Porcentajes y su relación con decimales y fracciones"
      />
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Porcentajes y su relación con decimales y fracciones</h1>
            <Game3
            ...
            <div className="mt-8">
              ...
              <p className="text-xl font-semibold">Estrellas: {score} / 200</p> {/* Actualización del total a 200 */}
