...
const Game4 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/coordenadas/game4'), { ssr: false });
    ...
    <main className="bg-gray-100">
      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="ml-8 inline-block mb-20">
          <Link href="/niveles/nivel3/mate/geometria/coordenadas/juegos">
        ...
        <div className="flex items-center my-6 mx-auto">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/figangu.png" alt="Decimales" className="h-40 w-auto" />
          </div>
          {/* Typewriter y botón */}
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[1300px]"> {/* Ajuste del ancho del contenedor del juego */}
            <h1 className="text-3xl font-bold mb-4 text-center">Identifica las características de las coordenadas en el plano</h1>
            <Game4 
              key={gameKey} 
