...
const Game1 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/coordenadas/game1'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Que es un plano?</h1>
            <Game1 
              key={gameKey} 
