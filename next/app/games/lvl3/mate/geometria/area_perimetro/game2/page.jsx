// Juego 2 - Area y perimetro- Nivel 3
"use client";
...
const Game2 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/area_perimetro/game2'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Cuál es el area?</h1>
            <Game2
