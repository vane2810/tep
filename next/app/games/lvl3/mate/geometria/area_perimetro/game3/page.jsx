// Juego 3 - Área y Perímetro - Nivel 3
"use client";
...
const Game3 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/area_perimetro/game3'), { ssr: false });
    ...
    <main className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-between items-center">
        ...
        <div className="inline-block mb-20 ml-8">
          <Link href="/niveles/nivel3/mate/geometria/area_perimetro/juegos">
        ...
        <div className="flex items-center mx-auto my-6">
          ...
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/figperi.png" alt="Decimales" className="w-auto h-40" />
          </div>
          {/* Typewriter y botón */}
      ...
      <Game1Modal
        ...
        subtitle="Hay que encontra el area"
      />
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Encontremos el area</h1>
            <Game3 
