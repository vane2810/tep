...
const Game3 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/pitagoras/game3'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Encontremos a Pitagoras"
      />
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Encontremos a Pitagoras</h1>
            <Game3 
