// Juego 1 - Teorema de pitagoras - Nivel 3
"use client";
...
const Game1 = dynamic(() => import('@/components/minigame/lvl3/mate/geometria/pitagoras/game1'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="Aprendiendo con Pitagoras"
      />
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            <h1 className="text-3xl font-bold mb-4 text-center">Aprendiendo con Pitagoras</h1>
            <Game1 
              key={gameKey} 
