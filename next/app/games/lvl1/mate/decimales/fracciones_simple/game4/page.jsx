// Juego 4 - Fracciones Simples - Nivel 1
"use client";
...
const Game4 = dynamic(() => import('@/components/minigame/lvl1/mate/decimales/fraccciones_simples/game4'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Convirtamos fracciones</h1>
            <Game4 
              key={gameKey} 
