...
const Game3 = dynamic(() => import('@/components/minigame/lvl1/mate/decimales/fraccciones_simples/game3'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Cual es mayor?</h1>
            <Game3
            ...
            <div className="mt-8">
              ...
              <p className="font-semibold text-xl">Estrellas: {score} / 200</p> {/* Actualización del total a 100 */}
