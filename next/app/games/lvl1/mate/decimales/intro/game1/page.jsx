...
const Game1 = dynamic(() => import('@/components/minigame/lvl1/mate/decimales/intro/game1'), { ssr: false });
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center"> Identificación de Decimales</h1>
            <Game1 
              key={gameKey} 
