// Página del Juego 3 - Resta - Nivel 1
"use client";
...
//Importacion de juego
const Game3 = dynamic(() => import('@/components/minigame/lvl1/mate/ob/multiplicacion/game3'), { ssr: false });

const MultiGamePage3 = () => {
