...
const Game1 = dynamic(() => import('@/components/minigame/lvl1/mate/geometria/angulo/game1'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <Game1Modal
        ...
        subtitle="¿Cuando pasa el angulo?"
      />
      ...
      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">¿Cuando pasa el angulo?</h1>
            <Game1 
              key={gameKey} 
