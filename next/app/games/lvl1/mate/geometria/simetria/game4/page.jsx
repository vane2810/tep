...
const Game4 = dynamic(() => import('@/components/minigame/lvl1/mate/geometria/simetria/game4'), { ssr: false });
  ...
  return (
    <main className="bg-gray-100">
      ...
      <div className="flex flex-wrap justify-between items-center">
        ...
        <div className="flex items-center mx-auto my-6">
          <div className="flex-shrink-0 mr-4">
            <img src="/img/niveles/mate/figsime.png" alt="Figuras Geométricas" className="w-auto h-40" />
          </div>
      ...
      <Game4Modal
        ...
        subtitle="Informate simetricamente"
      />

      {gameStarted && (
        <section className='flex flex-col items-center min-h-screen'>
          <div className="bg-white shadow-lg my-16 p-6 rounded-lg w-[850px] story">
            <h1 className="mb-4 font-bold text-3xl text-center">Informate simetricamente</h1>
            <div className="mt-8">
