...
const SumGamePage3 = () => {
  ...
  const handleGameEnd = () => {
    ...
    // No detenemos `gameStarted` aquí para mantener el mensaje final visible
  };
          ...
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            ...
            <div className="flex justify-center w-full max-w-4xl mx-auto ">
              <Game3
                ...
                updateScore={setScore} // Pasar el puntaje actualizado
                updateQuestionCount={setQuestionCount} // Pasar el contador de preguntas actualizado
                endGame={handleGameEnd} // Pasar la función endGame correctamente
              />
            </div>
