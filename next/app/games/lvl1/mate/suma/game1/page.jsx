...
const SumGamePage1 = () => {
  ...
  const handleRetry = () => {
    // Incrementar gameKey para forzar la recreación del componente Game1
    setGameKey(prevKey => prevKey + 1);
    setFeedback(''); // Resetear el feedback
    setScore(0); // Resetear el score
    setShowRetry(false); // Ocultar el botón de retry
  };
      ...
      {gameStarted && (
        <section className='min-h-screen flex flex-col items-center'>
          <div className="my-16 p-6 story bg-white rounded-lg shadow-lg w-[850px]">
            ...
            <Game1 
              key={gameKey} // Forzar recreación del componente Game1
