  ...
  return (
    ...
    <div className="flex flex-col bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col flex-grow justify-center items-center">
        ...
        <div className="gap-24 grid grid-cols-2 mb-8 story">
          {/* Gestión de Usuarios */}
          ...
          <Link href="/alerts" className="flex flex-col items-center group">
            <FaBell className="group-hover:text-red-700 group-hover:scale-110 shadow-lg mb-6 text-9xl text-red-500 transform transition duration-300" />
            <span className="group-hover:text-red-700 font-semibold text-2xl text-black transition duration-300">Monitoreo y Alertas</span>
          </Link>
        </div>
      </div>
    </div>
