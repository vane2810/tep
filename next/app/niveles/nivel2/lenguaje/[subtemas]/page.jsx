// Página principal de subtemas nivel2 - lenguaje
"use client";
...
const SubtemasPage = () => {
  ...
  const subtemasData = {
    ...
    generos_literarios: {
      titulo: "GÉNEROS LITERARIOS | NIVEL II",
