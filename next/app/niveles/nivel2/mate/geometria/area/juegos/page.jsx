 ...
 {/*CAMBIAR DIRECCIÓN DE LOS JUEGOS*/}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 px-8 py-8">
        <div 
          ...
          onClick={() => openModal("Juego 1", "/games/lvl2/mate/geometria/area/game1")}
        >
          Juego 1
        </div>
        ...
        <div 
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("SJuego 2", "/games/lvl2/mate/geometria/area/game2")}
        >
          Juego 2
        </div>
        ...
        <div 
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Juego 3", "/games/lvl2/mate/geometria/area/game3")}
        >
          Juego 3
        </div>
        ...
        <div 
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Juego 4", "/games/lvl2/mate/geometria/area/game4")}
        >
          Juego 4
        </div>
      </section>
