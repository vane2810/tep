// Página de inicio de lo juegos de fracciones equivalentes / Nivel 2
"use client"
    ...
    <main className="container mx-auto">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 px-8 py-8">
        <div
          ...
          onClick={() => openModal("Términos de la Suma", "/games/lvl2/mate/decimales/equivalentes/game1")}
        >
          Juego 1
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Suma de Décenas y Unidades", "/games/lvl2/mate/decimales/equivalentes/game2")}
        >
          Juego 2
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Sumas Flotantes", "/games/lvl2/mate/decimales/equivalentes/game3")}
        >
          Juego 3
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Sumas Avanzada", "/games/lvl2/mate/decimales/equivalentes/game4")}
        >
          Juego 4
        </div>
      </section>
