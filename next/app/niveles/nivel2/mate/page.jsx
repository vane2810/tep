// Página de Inicio de Matemáticas - Nivel 2
      ...
      <section className="my-20">
        <div className="flex flex-wrap justify-center gap-4 mt-5 mx-2.5">
          ...
          <Link href="/niveles/nivel2/mate/multimedia">
            <img src="/img/niveles/mate/nivel2/repa.png" alt="Resolucion de problemas" className="w-36 md:w-64 h-36 md:h-64 md:mr-3 animate-salto" />
          </Link>
        </div>
      </section>
