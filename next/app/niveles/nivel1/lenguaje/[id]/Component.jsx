...
export default function ClientBookComponent({ id }) {
            ...
            <div className="top-[10%] right-[10%] absolute p-8 w-[38%] h-[65%]">
              ...
              <div className="right-4 bottom-4 absolute">
                {currentPage < lecciones.length - 1 ? (
                  ...
                  <button className="bg-green-500 hover:bg-green-700 px-6 py-2 rounded-lg text-white text-xl transition duration-300 story">
                    Jugar
                  </button>
                )}
              </div>
