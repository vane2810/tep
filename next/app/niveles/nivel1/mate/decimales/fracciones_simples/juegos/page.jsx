// Página de inicio de lo juegos de fracciones simples / Nivel 1
"use client"
  ...
  return (
    <main className="container mx-auto">
      ...
      <section className="flex flex-col items-center justify-center mb-14">
        <h2 className="text-2xl md:text-4xl font-bold mt-4 story">¡Bienvenido a los juegos de fracciones simples!</h2>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 px-8 py-8">
        <div
          ...
          onClick={() => openModal("Identificación de Fracciones Simples", "/games/lvl1/mate/decimales/fracciones_simple/game1")}
        >
          Juego 1
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Comparación de fracciones y decimales", "/games/lvl1/mate/decimales/fracciones_simple/game2")}
        >
          Juego 2
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("¿Cual es mayor?", "/games/lvl1/mate/decimales/fracciones_simple/game3")}
        >
          Juego 3
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Convirtamos fracciones", "/games/lvl1/mate/decimales/fracciones_simple/game4")}
        >
          Juego 4
        </div>
      </section>
