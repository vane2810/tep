    ...
    <main>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/nivel1/ob/multiplicacion/paso1multiplicacion.png" alt="multiplicacion" className="h-32 w-auto ml-4" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/nivel1/ob/multiplicacion/paso2multiplicacion.png" alt="multiplicacion" className="h-32 w-auto ml-4" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/nivel1/ob/multiplicacion/paso3multiplicacion.png" alt="Multiplicación" className="h-32 w-auto ml-5" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/nivel1/ob/multiplicacion/paso4multiplicacion.png" alt="multiplicacion" className="h-32 w-auto ml-4" />
        </div>
      </section>
