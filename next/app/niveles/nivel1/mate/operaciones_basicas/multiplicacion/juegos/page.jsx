// Página de ininio de lo juegos de multiplicacion / Nivel 1
"use client"
...
export default function PageGameMulti() {
  ...
  return (
    <main className="container mx-auto">
      ...
      <section className="flex flex-col items-center justify-center mb-14">
        <h2 className="text-2xl md:text-4xl font-bold mt-4 story">¡Bienvenido a los Juegos de Multiplicación!</h2>
