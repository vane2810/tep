  ...
  return (
    <main>
      ...
      <section className="my-10 px-4">
        <div className="flex flex-col md:flex-row items-center text-center">
          <div className="flex-1 mb-4 md:mb-0">
            <h2 className="text-xl md:text-2xl font-semibold">Geometría analítica</h2>
            <p className="mt-2 text-black text-sm md:text-base">
            Uso de ecuaciones para describir líneas y figuras en el plano cartesiano, explorando la relación entre álgebra y geometría.
            </p>
            <Link href="/niveles/nivel1/mate/operaciones_basicas/division">
              <button className="mt-4 px-4 py-2 bg-orange-500 text-black rounded hover:bg-orange-300">Describamos figuras!</button>
            </Link>
          </div>
