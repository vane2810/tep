    ...
    <main>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/paso1restan3.png" alt="Resta" className="h-32 w-auto ml-4" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/paso2restan3.png" alt="Resta" className="h-32 w-auto ml-4" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/paso3restan3.png" alt="Resta" className="h-32 w-auto ml-5" />
        </div>
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          ...
          <img src="/img/niveles/mate/paso4restan3.png" alt="Resta" className="h-32 w-auto ml-4" />
        </div>
      </section>
    </main>
  );
