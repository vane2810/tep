// /pages/niveles/nivel3/matematicaPage.js
"use client";
  ...
  return (
    <main>
        ...
        <div className="bg-purple-200 py-4">
          ...
          <div className="flex flex-col justify-center items-center mb-5 text-center">
            <div className="flex justify-center items-center">
              <img src="/img/niveles/mate/figuritamate1.png" alt="Animated Image" className="mr-4 w-auto h-64" />
              <p className="max-w-lg text-[40px] text-black super">
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          <div className="flex-1 text-center">
            <h2 className="font-semibold text-2xl">Suma</h2>
            ...
            <Link href="/niveles/nivel3/mate/operaciones_basicas/suma">
              <button className="bg-pink-500 hover:bg-pink-300 mt-4 px-4 py-2 rounded text-black">¡Vamos a sumar!</button>
            </Link>
          </div>
          <img src="/img/niveles/mate/N1.png" alt="Suma" className="ml-4 w-auto h-32" />
        </div>
        <SeparadorRosa />
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          <div className="flex-1 text-center">
            <h2 className="font-semibold text-2xl">Resta</h2>
            <p className="mt-2 text-black">
            ...
            <Link href="/niveles/nivel3/mate/operaciones_basicas/resta">
              <button className="bg-green-500 hover:bg-green-300 mt-4 px-4 py-2 rounded text-black">¡Vamos a restar!</button>
            </Link>
          </div>
          <img src="/img/niveles/mate/N2.png" alt="Resta" className="ml-4 w-auto h-32" />
        </div>
        <SeparadorVerde />
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          <div className="flex-1 text-center">
            <h2 className="font-semibold text-2xl">Multiplicación</h2>
            <p className="mt-2 text-black">
            ...
            <Link href="/niveles/nivel3/mate/operaciones_basicas/multiplicacion">
              <button className="bg-blue-500 hover:bg-blue-300 mt-4 px-4 py-2 rounded text-black">¡Vamos a multiplicar!</button>
            </Link>
          </div>
          <img src="/img/niveles/mate/N3.png" alt="Multiplicación" className="ml-4 w-auto h-32" />
        </div>
        <SeparadorCeleste />
      </section>
      ...
      <section className="my-10 px-4">
        <div className="flex items-center">
          <div className="flex-1 text-center">
            <h2 className="font-semibold text-2xl">División</h2>
            <p className="mt-2 text-black">
            ...
            <Link href="/niveles/nivel3/mate/operaciones_basicas/division">
              <button className="bg-orange-500 hover:bg-orange-300 mt-4 px-4 py-2 rounded text-black">¡Vamos a dividir!</button>
            </Link>
          </div>
          <img src="/img/niveles/mate/N4.png" alt="División" className="ml-4 w-auto h-32" />
        </div>
        <SeparadorAmarillo />
      </section>
    </main>
