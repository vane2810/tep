// Página de inicio de lo juegos número decimales en la vida cotidiana/ Nivel 3
"use client"
  ...
  return (
    <main className="container mx-auto">
      ...
      <section className="flex flex-col items-center justify-center mb-14">
        <h2 className="text-2xl md:text-4xl font-bold mt-4 story">¡Bienvenido a los juegos de aplicación de decimales en la vida cotidiana!</h2>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 px-8 py-8">
        <div
          ...
          onClick={() => openModal("Términos de la Suma", "/games/lvl3/mate/decimales/aplicacion/game1")}
        >
          Juego 1
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Suma de Décenas y Unidades", "/games/lvl3/mate/decimales/aplicacion/game2")}
        >
          Juego 2
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Sumas Flotantes", "/games/lvl3/mate/decimales/aplicacion/game3")}
        >
          Juego 3
        </div>
        ...
        <div
          className="border text-xl font-semibold story border-gray-300 rounded-lg p-8 flex flex-col 
          items-center justify-center hover:bg-gray-100 transition duration-300 cursor-pointer celeste"
          onClick={() => openModal("Sumas Avanzada", "/games/lvl3/mate/decimales/aplicacion/game4")}
        >
          Juego 4
        </div>
      </section>
